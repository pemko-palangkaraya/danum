...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('permission:population.view')->group(function () { Route::get('/population/citizens/export', [PopulationExportController::class, 'citizens'])->name('population.citizens.export'); Route::get('/population/families/pdf', [FamilyCardController::class, 'pdfAll'])->name('population.families.pdf.all'); Route::get('/population/families/{id}/pdf', [FamilyCardController::class, 'pdf'])->name('population.families.pdf'); });
