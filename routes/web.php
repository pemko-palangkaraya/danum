...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('superadmin')->group(function () {
        ...
        Route::middleware('permission:population.view')->group(function () { Volt::route('/population/citizens', 'pages.population.citizens')->name('population.admin.citizens.index'); Volt::route('/population/families', 'pages.population.families')->name('population.admin.families.index'); });
