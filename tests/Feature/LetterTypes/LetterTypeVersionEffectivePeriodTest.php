...
class LetterTypeVersionEffectivePeriodTest extends TestCase
{
    ...
    public function test_active_version_is_resolved_by_effective_period(): void
    {
        ...
        $v1 = LetterTypeVersion::factory()->create(['letter_type_id' => $type->id, 'version' => 1, 'body_template' => 'v1', 'is_active' => true, 'effective_from' => '2026-08-01 00:00:00', 'effective_until' => '2026-09-01 00:00:00']);
        $v2 = LetterTypeVersion::factory()->create(['letter_type_id' => $type->id, 'version' => 2, 'body_template' => 'v2', 'is_active' => true, 'effective_from' => '2026-09-01 00:00:00']);
    ...
    {
        $type = LetterType::factory()->create(['body_template' => 'v1']);
        $old = LetterTypeVersion::factory()->create(['letter_type_id' => $type->id, 'version' => 1, 'body_template' => 'old', 'is_active' => false, 'effective_from' => '2026-01-01 00:00:00']);
        LetterTypeVersion::factory()->create(['letter_type_id' => $type->id, 'version' => 2, 'body_template' => 'new', 'is_active' => true, 'effective_from' => '2026-01-01 00:00:00']);
