...
class FamilySuccessionTest extends TestCase
{
    ...
    public function test_living_spouse_becomes_family_head_and_widow_status(): void
    {
        ...
        FamilyMember::factory()->forFamily($family)->forCitizen($husband)->relation('head')->create();
    ...
    public function test_oldest_living_child_becomes_head_after_both_parents_die(): void
    {
        ...
        FamilyMember::factory()->forFamily($family)->forCitizen($father)->relation('head')->create();
        FamilyMember::factory()->forFamily($family)->forCitizen($mother)->relation('spouse')->create();
        ...
        $this->assertDatabaseHas('family_members', [
            ...
            'hubungan_dalam_keluarga' => 'parent',
        ]);
        $this->assertDatabaseHas('family_members', [
            'family_id' => $family->id,
