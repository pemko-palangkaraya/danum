...
class Index extends Component
{
    ...
    public function edit(string $id): void
    {
        try {
            ...
            if (! $letterType || $tenantId === null || ! app(LetterTypeService::class)->isAllowedForTenant($letterType, $tenantId)) {
    ...
    public function save(OutgoingLetterDraftService $drafts): void
    {
        try {
            ...
            if ($tenantId === null || ! $tenant) {
                throw new \DomainException('Akun platform tidak dapat membuat surat tanpa konteks tenant.');
            }
