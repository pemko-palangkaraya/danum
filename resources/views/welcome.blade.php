    ...
    <style>
        ...
        * {
        ...
        .preview-card::before {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(115deg, transparent 28%, rgba(255, 255, 255, .72) 45%, transparent 60%);
        ...
        .preview-card::after {
            ...
            bottom: 18px;
            background: #fbbd00;
            box-shadow: 0 0 0 5px rgba(251, 189, 0, .10);
        ...
        .metric:nth-child(1) {
            animation: metricLift 4.2s ease-in-out infinite;
        }

        .metric:nth-child(2) {
            animation: metricLift 4.2s ease-in-out .45s infinite;
        }

        .metric:nth-child(3) {
            animation: metricLift 4.2s ease-in-out .9s infinite;
        }
        ...
        .step.active::after {
            ...
            animation: stepSweep 2.8s ease-in-out infinite;
        }
    ...
    <div class="landing">
        ...
        <main>
            <section class="hero">
                <div>
                    ...
                    <p class="lead">DANUM — Sederhanakan data, percepat proses, dorong pertumbuhan.</p>
            ...
            <section id="fitur" class="features">
                <article class="feature">
                    ...
                    <h2>Alur surat terstruktur</h2>
                    <p>Surat bergerak melalui tahapan draft, verifikasi, siap TTE, dan terbit dengan status yang jelas.</p>
                </article>
                <article class="feature">
                    <div class="feature-icon">02</div>
                    <h2>Tanda tangan elektronik</h2>
                    <p>Dokumen dapat diterbitkan melalui proses TTE dengan sertifikat dan PIN penanda tangan.</p>
                </article>
                <article class="feature">
                    <div class="feature-icon">03</div>
                    <h2>Jejak administrasi</h2>
                    <p>Aktivitas dan perubahan penting tercatat sehingga proses persuratan lebih mudah ditelusuri.</p>
                </article>
            </section>
        </main>
        ...
        <footer class="footer">
            <div class="footer-inner">
                <span>© {{ date('Y') }} DANUM</span>
                <span>Sejak 2025 · Menyederhanakan administrasi, memudahkan layanan.</span>
            </div>
