...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .preview-wrap::before,
        .preview-wrap::after { content: ""; position: absolute; border-radius: 50%; pointer-events: none; }
        ...
        @keyframes metricLift {
            ...
            50% { transform: translateY(-3px); box-shadow: 0 7px 18px rgba(15,23,42,.055); }
        }
        @keyframes stepSweep {
        ...
        @media (prefers-reduced-motion: reduce) {
            .preview-wrap::before, .preview-wrap::after, .preview-card, .preview-card::before, .preview-card::after,
            .pill, .metric, .step.active::after { animation: none; }
        }
        ...
        @media (max-width: 820px) {
            ...
            .preview-wrap { padding: 8px 4px 18px; }
            .preview-card { transform: none; animation-name: cardFloatMobile; }
